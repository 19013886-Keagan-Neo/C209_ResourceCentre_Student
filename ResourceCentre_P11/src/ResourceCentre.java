...
public class ResourceCentre {
	...
	private static final int OPTION_DISPLAY = 1;
	...
	public static void main(String[] args) {
		...
		while (option != OPTION_QUIT) { // KEAGAN

			ResourceCentre.menu();
			option = Helper.readInt("Enter an option > ");

			if (option == OPTION_DISPLAY) { // KEAGAN
				// View all items
			...
			} else if (option == OPTION_LOAN) { // KEAGAN
				// Loan item
			...
			} else if (option == OPTION_RETURN) { // KEAGAN
				// Return item
